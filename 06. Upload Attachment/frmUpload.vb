...
#Region "Procedures"
    ...
    Private Sub UploadData()
        ...
        For Each fi In aryFi
            ...
            Dim Jumlah As Integer = ExcelBook.Worksheets.Count
            ...
            For sheetNumber = 1 To Jumlah
                ...
                Try
                    ...
                    ElseIf templateCode = "TALLY" Then 'DIAN Export
                        ...
                        tmp.NamaKapal = IIf(IsNothing(ExcelSheet.Range("AQ8").Value), "", ExcelSheet.Range("AQ8").Value)
                                    ...
                                    ElseIf templateCode = "DO" Or templateCode = "DO (PO non Kanban)" Then
                                        ...
                                        If tmp.DOQty > 0 Then
                                            ...
                                            If inputMaster2 = False Then
                                                ...
                                                inputMaster2 = True
                                            End If
                                            clsTmpDB.insertDetailDO(tmp, SQLCom)
                                        End If
                                                ...
                                                If ExcelSheet.Range("B" & i).Value.ToString <> "E" Then
                                                    ...
                                                    Else 'DN BARU
                                                        ...
                                                        If tmp.DOQty > 0 Then
                                                            ...
                                                            If IsNewRecEx = True Then
                                                                For i_loopBox = 0 To tmp.m_JmlBox - 1
                                                                    If clsTmpDB.CekBoxNoDNSupplier(tmp.PartNo, ls_boxno + Microsoft.VisualBasic.Right("000000" & (startBox + i_loopBox), 7)) = 0 Then
                                                                        statusSave = False
            ...
            If templateCode = "REC-EX" Then
                ...
                If sts = False Then
                    retMessage = SendEmailEx(ReceipientList, CCList, EmailPASI.EmailPASITo, SubjectBody.Subject, _
                         SubjectBody.Body, EmailSetting.SenderName, EmailSetting.Password, EmailSetting.EnableSSL, EmailSetting.SMTPServer, EmailSetting.Port, pFileName)
                Else
                    retMessage = SendEmailEx(ReceipientList, CCList, EmailPASI.EmailPASITo, SubjectBody.Subject, _
