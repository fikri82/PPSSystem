...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Session("KCR-ReportCode") = "KanbanCard" Then
            ...
            ls_sql = ls_sql + "         PartNo1 = LEFT(Rtrim(KD.PartNo),2) , " & vbCrLf & _
                              "         PartNo2 = SUBSTRING(Rtrim(KD.PartNo),3,9) , " & vbCrLf & _
                              "         PartNo3 = SUBSTRING(Rtrim(KD.PartNo),10,10) , " & vbCrLf & _
                              ...
                              "         Qty = Replace(Rtrim(ML.QtyBox),'.00','') , " & vbCrLf & _
                              "         BoxNo = Rtrim(isnull(KB.BoxNo,'')) , " & vbCrLf & _
                              "         Cust = RTRIM(KM.AffiliateID) , " & vbCrLf & _
                              "         AFFCode = Rtrim(ISNULL(MA.AffiliateCode, '')) , " & vbCrLf & _
                              "         Location = Rtrim(ISNULL(ML.LocationID, '')) , " & vbCrLf & _
                              "         SupplierID = RTRIM(KM.SupplierID) + '#1' , " & vbCrLf & _
