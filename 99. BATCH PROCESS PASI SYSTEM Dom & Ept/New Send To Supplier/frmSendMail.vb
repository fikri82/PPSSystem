    ...
    Private Sub up_SendExport()
        If POExport = True Then
            ...
            If DNExport = True Then
                ...
                rtbProcess.Text = Format(Now, "yyyy-MM-dd HH:mm:ss") & " Start Send Invoice Export to Supplier " & vbCrLf & _
                                " " & vbCrLf & _
                                rtbProcess.Text
...
Split:
                    ...
                    rtbProcess.Text = Format(Now, "yyyy-MM-dd HH:mm:ss") & " [Export] Create File " & temp_Filename1 & temp_Filename2 & " NG. " & vbCrLf & _
                    rtbProcess.Text
...
keluar:
    ...
    Private Sub up_InvoiceSupplierExport()
        ...
        If Not fi.Exists Then
            rtbProcess.Text = Format(Now, "yyyy-MM-dd HH:mm:ss") & " Process Send Invoice Export to Supplier STOPPED, because File Excel isn't Found " & vbCrLf & _
                            rtbProcess.Text
            Exit Sub
        End If
        ...
        If dsAffiliate.Tables(0).Rows.Count = 0 Then ' STOP Karena ga ada di Master Affiliate
            rtbProcess.Text = Format(Now, "yyyy-MM-dd HH:mm:ss") & " Process Send Invoice Export to Supplier STOPPED, because Data for Affiliate : '" & AffID & "' isn't Found " & vbCrLf & rtbProcess.Text
            Exit Sub
        End If

        If dsSupplier.Tables(0).Rows.Count = 0 Then ' STOP Karena ga ada di Master Supplier
            rtbProcess.Text = Format(Now, "yyyy-MM-dd HH:mm:ss") & " Process Send Invoice Export to Supplier STOPPED, because Data for Supplier : '" & SuppID & "' isn't Found " & vbCrLf & rtbProcess.Text
            Exit Sub
        End If

        If ds.Tables(0).Rows.Count = 0 Then ' STOP Karena ga ada Data nya
            rtbProcess.Text = Format(Now, "yyyy-MM-dd HH:mm:ss") & " Process Send Invoice Export to Supplier STOPPED, because Data for SJ : '" & SJNo & "' and Supp '" & SuppID & "' and Order '" & OrderNo & "' isn't Found " & vbCrLf & rtbProcess.Text
            Exit Sub
        End If
        ...
        Catch ex As Exception
            rtbProcess.Text = Format(Now, "yyyy-MM-dd HH:mm:ss") & " Process Invoice Export to Supplier STOPPED, because " & Err.Description & " " & vbCrLf & _
                                    rtbProcess.Text
            xlApp.Workbooks.Close()
            xlApp.Quit()
        Finally
    ...
    Private Function sendEmailInvoice_EXPORT(ByVal pFilename As String, ByVal pEmailFrom As String, ByVal pEmailTo As String, ByVal pEmailCC As String, ByVal pSjNo As String, ByVal pSuppID As String) As Boolean 'Link Affiliate Order Entry
        Try
            ...
            rtbProcess.Text = Format(Now, "yyyy-MM-dd HH:mm:ss") & " Process Send Invoice SJ No: " & pSjNo & " to Supplier SUCCESSFULL" & vbCrLf & _
                             rtbProcess.Text
        Catch ex As Exception
            rtbProcess.Text = Format(Now, "yyyy-MM-dd HH:mm:ss") & " Process Send Invoice SJ No: " & pSjNo & " to Supplier STOPPED, because " & ex.Message & " " & vbCrLf & _
                            rtbProcess.Text
