...
#Region "PROCEDURE"
    Private Sub bindData()
        ...
        Using sqlConn As New SqlConnection(clsGlobal.ConnectionString)
            ...
            ls_SQL = " SELECT RTRIM(AffiliateID)AffiliateID," & vbCrLf & _
                        ...
                        "RTRIM(ConsigneeName)ConsigneeName," & vbCrLf & _
                        "RTRIM(ConsigneeAddress)ConsigneeAddress," & vbCrLf & _
                        "RTRIM(BuyerName)BuyerName," & vbCrLf & _
                        "RTRIM(BuyerAddress)BuyerAddress," & vbCrLf & _
                        ...
                        "ISNULL(RTRIM(KantorPabean),'')KantorPabean," & vbCrLf & _
                        "ISNULL(RTRIM(IzinTPB),'')IzinTPB," & vbCrLf & _
                        "ISNULL(RTRIM(BCPerson),'')BCPerson," & vbCrLf & _
                        "ISNULL(RTRIM(DestinationPort),'')DestinationPort," & vbCrLf & _
                        "ISNULL(RTRIM(DestinationPortAir),'')DestinationPortAir," & vbCrLf & _
                        "ISNULL(RTRIM(OverseasCls),'0')OverseasCls," & vbCrLf & _
                        "ISNULL(RTRIM(PaymentTerm),'')PaymentTerm," & vbCrLf & _
                        "ISNULL(RTRIM(POCode),'0')POCode," & vbCrLf & _
                        "ISNULL(RTRIM(AffiliateCls),'A')AffiliateCls," & vbCrLf & _
                        "RTRIM(PODeliveryBy)PODeliveryBy, RTRIM(FolderOES)FolderOES, RTRIM(ISNULL(Att,''))Att" & vbCrLf & _
    ...
    Private Sub SaveData(ByVal pIsNewData As Boolean, _
                         ...
                         Optional ByVal pOverseasCls As String = "", _
                         Optional ByVal pPort As String = "", _
                         Optional ByVal pPortAir As String = "", _
        ...
        Using sqlConn As New SqlConnection(clsGlobal.ConnectionString)
            ...
            Using sqlTran As SqlTransaction = sqlConn.BeginTransaction("CostCenter")
                ...
                If pIsNewData = True Then
                    '#INSERT NEW DATA
                    ls_SQL = " INSERT INTO MS_Affiliate " & _
                                ...
                                " VALUES ('" & txtAffiliateID.Text & "','" & txtConsigneeCode.Text & "','" & txtConsigneeName.Text & "','" & txtBuyerCode.Text & "','" & txtBuyerName.Text & "','" & txtAffiliateName.Text & "','" & txtAddress.Text & "','" & txtConsigneeAddress.Text & "','" & txtBuyerAddress.Text & "','" & txtCity.Text & "'," & _
                                "'" & txtPostalCode.Text & "','" & txtPhone1.Text & "','" & txtPhone2.Text & "','" & txtFax.Text & "','" & txtNPWP.Text & "','" & txtKantorPabean.Text & "','" & txtIzinTPB.Text & "','" & txtBCPerson.Text & "','" & pPODel & "',getdate(),'" & admin & "', '" & txtPath.Text & "','" & txtPort.Text & "','" & txtPortAir.Text & "','" & pOverseasCls & "','0000','" & txtAtt.Text & "','" & txtPaymentTerm.Text & "','" & txtPOCode.Text & "','" & pAffCls & "')" & vbCrLf
                    ls_MsgID = "1001"
                ...
                ElseIf pIsNewData = False Then
                    '#UPDATE DATA
                    ls_SQL = "UPDATE MS_Affiliate SET " & _
                            "AffiliateName='" & txtAffiliateName.Text & "'," & _
                            "ConsigneeCode='" & txtConsigneeCode.Text & "'," & _
                            "BuyerCode='" & txtBuyerCode.Text & "'," & _
                            "Address='" & txtAddress.Text & "'," & _
                            "ConsigneeName='" & txtConsigneeName.Text & "'," & _
                            "ConsigneeAddress='" & txtConsigneeAddress.Text & "'," & _
                            "BuyerName='" & txtBuyerName.Text & "'," & _
                            "BuyerAddress='" & txtBuyerAddress.Text & "'," & _
                            "City='" & txtCity.Text & "'," & _
                            ...
                            "NPWP='" & txtNPWP.Text & "'," & _
                            "Att='" & txtAtt.Text & "'," & _
                            "KantorPabean='" & txtKantorPabean.Text & "'," & _
                            "IzinTPB='" & txtIzinTPB.Text & "'," & _
                            "BCPerson='" & txtBCPerson.Text & "'," & _
                            "PODeliveryBy='" & pPODel & "'," & _
                            "FolderOES ='" & txtPath.Text & "'," & _
                            "POCode ='" & txtPOCode.Text & "'," & _
                            "PaymentTerm ='" & txtPaymentTerm.Text & "'," & _
                            "OverseasCls ='" & pOverseasCls & "'," & _
                            "DestinationPort ='" & pPort & "'," & _
                            "DestinationPortAir ='" & pPortAir & "'," & _
                            "AffiliateCls ='" & pAffCls & "'," & _
