    ...
    <script type="text/javascript">
        ...
        function OnGetRowValues(values) {
            if (values[0] != "" && values[0] != null && values[0] != "null") {
                ...
                txtPartnoDetail.SetText(values[1]);
                            ...
                            <table id="Table1">
                                <tr>
                                    ...
                                    <td align="left" valign="middle" class="style18">
                                        ...
                                        <dx:ASPxTextBox ID="txtPartNo" runat="server" Width="98%" Height="20px" ClientInstanceName="txtPartNo"
                                            Font-Names="Tahoma" Font-Size="8pt" MaxLength="100"
                                ...
                                <tr>
                                    ...
                                    <td align="left" valign="middle" class="style18">
                                        ...
                                        <dx:ASPxComboBox ID="cboSupplier" runat="server" ClientInstanceName="cboSupplier"
                                            Width="98%" Font-Size="8pt" Font-Names="Tahoma" TextFormatString="{0}" TabIndex="1">
                                            <ClientSideEvents SelectedIndexChanged="function(s, e) {
                                    ...
                                    <td align="left" valign="middle" class="style7">
                                        <dx:ASPxTextBox ID="txtSupplier" runat="server" Width="98%" Height="20px" ClientInstanceName="txtSupplier"
                                            ...
                                            <tr>
                                                <td align="right" valign="middle" style="height: 25px; width: 90px;">
                                                    <dx:ASPxButton ID="btnRefresh" runat="server" Text="SEARCH" Font-Names="Tahoma" Width="85px"
                                                        ...
                                                        txtPartnoDetail.GetInputElement().setAttribute('style', 'background:#FFFFFF;foreground:#FFFFFF;');
