            ...
            <td align="left" valign="top" height="220" colspan="4">
                ...
                <dx:ASPxGridView ID="grid" runat="server" Width="100%"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="3" Caption="CONSIGNEE CODE" FieldName="ConsigneeCode" Width="90px" HeaderStyle-HorizontalAlign="Center">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="4" Caption="BUYER CODE" FieldName="BuyerCode" Width="90px" HeaderStyle-HorizontalAlign="Center">
                        </dx:GridViewDataTextColumn>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="23" Caption="AFFILIATE CLASSIFICATION" FieldName="AffiliateCls" Width="100px" HeaderStyle-HorizontalAlign="Center">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="24" Caption="PAYMENT TERM" FieldName="PaymentTerm" Width="100px" HeaderStyle-HorizontalAlign="Center">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="25" Caption="PO CODE (INVOICE CODE)" FieldName="POCode" Width="60px" HeaderStyle-HorizontalAlign="Center">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="26" Caption="PATH OES FOLDER" FieldName="FolderOES" Width="300px" HeaderStyle-HorizontalAlign="Center">
                        </dx:GridViewDataTextColumn>                        
                    </Columns>
