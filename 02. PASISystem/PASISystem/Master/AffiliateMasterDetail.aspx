...
<script language="javascript" type="text/javascript">
    ...
    function up_Insert() {
        ...
        AffiliateSubmit.PerformCallback('save|' + pIsUpdate + '|' + pAffiliateID + '|' + pAffiliateName + '|' + pAddress + '|' + pCity + '|' + pPostalCode + '|' + pPhone1 + '|' + pPhone2 + '|' + pFax + '|' + pNPWP + '|' + pPODel + '|' + pOverseasCls + '|' + pPort + '|' + pPortAir + '|' + pAffiliateCls);
    }
