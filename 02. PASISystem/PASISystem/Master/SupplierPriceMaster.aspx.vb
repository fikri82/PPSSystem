        ...
        Try
            ...
            Select Case pAction
                ...
                Case "downloadSummary"
                    ...
                    Dim dtProd As DataTable = clsMaster.GetTablePriceSupplier(txtPartNo.Text, cboSupplier.Text, pAdditional)
        ...
        Using sqlConn As New SqlConnection(clsGlobal.ConnectionString)
            ...
            If txtPartNo.Text <> "" Then
                If txtPartNo.Text <> clsGlobal.gs_All Then
                    ls_SQL = ls_SQL + "and PartNo like '%" & txtPartNo.Text & "%' "
                End If
            End If
            ...
            Using sqlTran As SqlTransaction = sqlConn.BeginTransaction("Price")
                ...
                ElseIf pIsNewData = False Then
                    ...
                    If pPrice <> pub_price Then
                        ls_Remarks = ls_Remarks + "Price " + Convert.ToString(pub_price) & "->" & Convert.ToString(pPrice) & " "
                    End If
