    ...
    Private Sub Grid_CustomCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridView.ASPxGridViewCustomCallbackEventArgs) Handles Grid.CustomCallback
        ...
        Select Case pAction
            ...
            Case "saveDataMaster"
                ...
                Call up_SaveMaster(Session("Sj"), "", ls_AffiliateID, ls_DeliveryDate, Session("UserID"), ls_JenisArmada, ls_DriverName, ls_DriverContact, ls_NoPol, ls_TotalBox, ls_InvoiceNo, _
                                   ls_FromDel, ls_ToDel, ls_Insu, ls_ViaDel, ls_AboutDel, ls_Privilege, ls_Vessel, ls_AWB, ls_PayTerms, ls_OnAbout, ls_ContainerNo, ls_Remarks, ls_Place)
...
#Region "PROCEDURE"
    ...
    Private Sub up_HeaderLoad(ByVal pSuratJalan As String, ByVal pSupplierID As String, ByVal pAffiliateID As String)
        ...
        Using sqlConn As New SqlConnection(clsGlobal.ConnectionString)
            ...
            ls_SQL = " SELECT * FROM PLPASI_Master WHERE SuratJalanNo='" & Trim(pSuratJalan) & "' AND SupplierID='" & Trim(pSupplierID) & "' AND AffiliateID='" & pAffiliateID & "'  "

            Dim sqlDA As New SqlDataAdapter(ls_SQL, sqlConn)
            Dim ds As New DataSet
            sqlDA.Fill(ds)
            If ds.Tables(0).Rows.Count > 0 Then
                txtFrom.Text = Trim(ds.Tables(0).Rows(0)("FromDelivery") & "")
    ...
    Private Sub up_SaveMaster(ByVal pSjno As String, ByVal pSupplierID As String, ByVal pAffiliateID As String, ByVal pDeliveryDate As String, ByVal pPIC As String, _
                            ByVal pjenisArmada As String, ByVal pDriverName As String, ByVal pDriverContact As String, ByVal pNopol As String, ByVal pTotalBox As String, _
                            ByVal pInvoiceNo As String, ByVal pFromDel As String, ByVal pToDel As String, ByVal pInsu As String, ByVal pViaDel As String, ByVal pAboutDel As String, _
                            ByVal pPrivilege As String, ByVal pVessel As String, ByVal pAWB As String, ByVal pPayTerms As String, ByVal pOnAbout As String, ByVal pContainerNo As String, _
                            ByVal pRemarks As String, ByVal pPlace As String)
        Dim ls_sql As String = ""
        ...
        Using sqlConn As New SqlConnection(clsGlobal.ConnectionString)
            ...
            Using sqlTran As New TransactionScope
                'save master
                ls_sql = Save_Master(pSjno, pSupplierID, pAffiliateID, pDeliveryDate, pPIC, pjenisArmada, pDriverName, pDriverContact, pNopol, pTotalBox, pInvoiceNo, _
                                    pFromDel, pToDel, pInsu, pViaDel, pAboutDel, pPrivilege, pVessel, pAWB, pPayTerms, pOnAbout, pContainerNo, pRemarks, pPlace)
    ...
    Private Function Save_Master(ByVal pSjno As String, ByVal pSupplierID As String, ByVal pAffiliateID As String, ByVal pDeliveryDate As String, ByVal pPIC As String, _
        ...
        ls_sql = ""
        ls_sql = ls_sql + " IF EXISTS(SELECT * FROM PLPASI_Master WHERE SuratJalanNo = '" & pSjno & "' AND SupplierID = '" & pSupplierID & "' AND AffiliateID = '" & pAffiliateID & "') " & vbCrLf & _
                          " BEGIN " & vbCrLf & _
                          " UPDATE dbo.PLPASI_Master " & vbCrLf & _
                          ...
                          "     ,[FromDelivery] = '" & pFromDel & "' " & vbCrLf & _
                          "     ,[ToDelivery] ='" & pToDel & "' " & vbCrLf & _
                          "     ,[InsurancePolicy] = '" & pInsu & "' " & vbCrLf & _
                          "     ,[ViaDelivery] = '" & pViaDel & "' " & vbCrLf & _
                          "     ,[AboutDelivery] ='" & pAboutDel & "' " & vbCrLf & _
                          "     ,[Privilege] = '" & pPrivilege & "' " & vbCrLf & _
                          "     ,[Vessel] = '" & pVessel & "' " & vbCrLf & _
                          "     ,[AWBBLNo] = '" & pAWB & "' " & vbCrLf & _
                          "     ,[PaymentTerms] = '" & pPayTerms & "' " & vbCrLf & _
                          "     ,[OnAbout] = '" & pOnAbout & "' " & vbCrLf & _
                          "     ,[ContainerNo] = '" & pContainerNo & "' " & vbCrLf & _
                          "     ,[Remarks] = '" & pRemarks & "' " & vbCrLf & _
                          "     ,[Place] = '" & pPlace & "' " & vbCrLf & _
        ...
        ls_sql = ls_sql + "     ,UpdateUser ='" & pPIC & "' " & vbCrLf & _
                          ...
                          " ELSE " & vbCrLf & _
                          " BEGIN " & vbCrLf & _
                          " INSERT INTO dbo.PLPASI_Master " & vbCrLf & _
                          "         ( SuratJalanNo ,SupplierID ,AffiliateID ,DeliveryDate ,PIC ,JenisArmada ,DriverName , " & vbCrLf & _
                          "           DriverContact ,NoPol ,TotalBox,[FromDelivery],[ToDelivery],[InsurancePolicy],[ViaDelivery],[AboutDelivery],[Privilege],[Vessel]" & vbCrLf & _
                          "           ,[AWBBLNo],[PaymentTerms],[OnAbout],[ContainerNo],[Remarks],[Place],InvoiceNo ,EntryDate ,EntryUser  " & vbCrLf & _
                          "         ) " & vbCrLf
