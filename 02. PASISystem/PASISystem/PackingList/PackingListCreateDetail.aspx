            ...
            <td align="left">
                <dx:ASPxGridView ID="Grid" runat="server" AutoGenerateColumns="False" KeyFieldName="NoUrut"
                    ...
                    <ClientSideEvents BatchEditStartEditing="OnBatchEditStartEditing" CallbackError="function(s, e) {e.handled = true;}"
                        ...
                        txtFrom.SetText(s.cpFromDelivery);
                        ...
                        <td style="width: 90px;">
                            <dx1:ASPxButton ID="btnsubmit" runat="server" Width="90px" Font-Names="Tahoma" Font-Size="8pt"
                                ...
                                <ClientSideEvents Click="function(s, e) {
                                    ...
                                    var millisecondsToWait = 4000;
                                            setTimeout(function() {
                                               Grid.PerformCallback('saveDataMaster|' + txtFrom.GetText() + '|' + txtTo.GetText() + '|' + txtInsurance.GetText() + '|' + txtVia.GetText() + '|' + txtAbout.GetText() + '|' + txtPrivilege.GetText() + '|' + txtVessel.GetText() + '|' + txtAwb.GetText() + '|' + txtPaymentTerms.GetText() + '|' + txtOn.GetText() + '|' + txtContainerNo.GetText() + '|' + txtRemarks.GetText() + '|' + txtPlace.GetText());
                                            }, millisecondsToWait);	
	                                Grid.CancelEdit();
                                }" />
                            </dx1:ASPxButton>
