    ...
    Private Sub up_GridLoad()
        ...
        Using sqlConn As New SqlConnection(clsGlobal.ConnectionString)
            ...
            ls_sql = ls_sql + " LEFT JOIN DOSupplier_Master_Export DSM ON DSM.PONo = POM.PONo " & vbCrLf & _
                              ...
                              " INNER JOIN DOSupplier_Detail_Export DSD ON DSD.Suratjalanno = DSM.Suratjalanno " & vbCrLf & _
            ...
            ls_sql = ls_sql + " AND DSB2.SupplierID = DSD.SupplierID " & vbCrLf & _
                              ...
                              " INNER JOIN ReceiveForwarder_Detail RD ON RD.Suratjalanno = RM.Suratjalanno " & vbCrLf & _
            ...
            ls_sql = ls_sql + " LEFT JOIN MS_UnitCls MU ON MU.UnitCls = MP.unitCls " & vbCrLf & _
                              ...
                              " )x where PartNo <> '' and Period between '" & Format(dtPeriodFrom.Value, "MMM yyyy") & "' and '" & Format(dtPeriodTo.Value, "MMM yyyy") & "'" & vbCrLf & _
                              "  " & vbCrLf
