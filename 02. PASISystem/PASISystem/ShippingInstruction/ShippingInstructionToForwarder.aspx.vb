        ...
        Try
            ...
            Using sqlConn As New SqlConnection(clsGlobal.ConnectionString)
                ...
                Using sqlTran As SqlTransaction = sqlConn.BeginTransaction("ExchangeRate")
                    ...
                    If Trim(cboCreate.Text) = "CREATE" Then
                        If pIsUpdate = True Then
                            ...
                            ls_SQL = " UPDATE dbo.ShippingInstruction_Master " & _
                                     ...
                                     "         where AffiliateID = '" & Trim(cboAffiliateCode.Text) & "' AND ForwarderID = '" & Trim(cboForwarder.Text) & "' AND ShippingInstructionNo = '" & Trim(cboShippingNo.Text) & "'" & vbCrLf
                    ...
                    'Untuk Update BL No dn BL Date ke Tally Data
                    ls_SQL = ls_SQL & " UPDATE dbo.Tally_Master SET " & vbCrLf & _
                            " BL_AWB_No = '" & Trim(txtBLNo.Text) & "', " & vbCrLf & _
                            " BL_AWB_Date = '" & Convert.ToDateTime(dtBLDate.Value).ToString("yyyy-MM-dd") & "' " & vbCrLf & _
                            " where ShippingInstructionNo = '" & Trim(cboShippingNo.Text) & "' " & vbCrLf & _
                            " and ForwarderID = '" & Trim(cboForwarder.Text) & "' " & vbCrLf & _
                            " and AffiliateID = '" & Trim(cboAffiliateCode.Text) & "' "
