                        ...
                        If ls_TampungError = 0 Then
                            ...
                            ElseIf pIsUpdateMaster = False Then
                                ...
                                ls_SQL = "INSERT INTO PO_Master_ExportCancel( " & vbCrLf & _
                                    ...
                                    "SupplierApprovalCls, ExcelCls, FinalApprovalCls, '" & ls_CancelReffPONo & "' SplitReffPONo, '" & Session("POStatus") & "' SplitStatus " & vbCrLf & _
                                                            ...
                                                            Case "5", "6"
                                                                ...
                                                                If Session("POStatus") = "6" Then
                                                                    ls_SQL = ls_SQL + "INSERT INTO ReceiveForwarder_MasterCancel(" & vbCrLf & _
                                                                        ...
                                                                        "GETDATE() EntryDate, '" & Session("UserID").ToString & "' EntryUser, NULL UpdateDate, NULL UpdateUser, MovingList, SplitReffPONo " & vbCrLf & _
