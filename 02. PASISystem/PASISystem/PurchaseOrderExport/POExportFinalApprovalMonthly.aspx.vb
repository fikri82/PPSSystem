    ...
    Private Sub bindDataHeader(ByVal pAffCode As String, ByVal pPONO As String, ByVal pOrderNo As String, ByVal pSuppCode As String)
        ...
        Using sqlConn As New SqlConnection(clsGlobal.ConnectionString)
            ...
            ls_SQL = " SELECT  " & vbCrLf & _
                  ...
                  " INNER JOIN PO_MasterUpload_Export b ON a.PONo = b.PONo and a.AffiliateID = b.AffiliateID and a.SupplierID = b.SupplierID and a.ForwarderID = b.ForwarderID and a.OrderNo1 = b.OrderNo1 " & vbCrLf & _
