...
#Region "PROCEDURE"
    ...
    Private Sub bindData()
        ...
        Using sqlConn As New SqlConnection(clsGlobal.ConnectionString)
            ...
            ls_SQL = "  select ROW_NUMBER() over (ORDER BY Period desc, PONo, OrderNo, SupplierID, AffiliateID ) as NoUrut , * " & vbCrLf & _
                  "  from " & vbCrLf & _
                  "  ( " & vbCrLf & _
            ...
            ls_SQL = ls_SQL + " ORDER BY Period desc, PONo, OrderNo, SupplierID, AffiliateID "
