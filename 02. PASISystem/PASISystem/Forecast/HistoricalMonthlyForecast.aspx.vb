...
#Region "Procedures"
    ...
    Private Sub FormatExcel(ByVal pExl As ExcelWorksheet, ByVal ds As DataSet)
        With pExl
            ...
            Dim rgAll As ExcelRange = .Cells(9, 1, ds.Tables(0).Rows.Count + 9, 21)
            EpPlusDrawAllBorders(rgAll)

            Dim rgAF As ExcelRange = .Cells(9, 1, ds.Tables(0).Rows.Count + 9, 21)
            rgAF.AutoFilter = True

            Dim rgHeader As ExcelRange = .Cells(9, 1, 9, 21)
