...
#Region "PROCEDURE"
    ...
    Private Sub bindData()
        ...
        Using sqlConn As New SqlConnection(clsGlobal.ConnectionString)
            ...
            ls_SQL = " select   " & vbCrLf & _
                  ...
                  "  	a.[AffiliateID], a.[ConsigneeCode], a.[ConsigneeName], a.[BuyerName], " & vbCrLf & _
                  " 	a.[BuyerCode], a.[AffiliateName], a.[Address], a.[ConsigneeAddress],  " & vbCrLf & _
                  " 	a.[BuyerAddress], a.[City], a.[PostalCode], a.[Phone1], a.[Phone2], " & vbCrLf & _
                  " 	a.[Fax], a.[NPWP], a.[KantorPabean], a.[IzinTPB], a.[BCPerson],  " & vbCrLf & _
                  " 	a.[PODeliveryBy], a.[FolderOES], a.[OverseasCls], a.[DestinationPort], a.[ErrorCls], " & vbCrLf & _
                  " 	xConsigneeCode = b.ConsigneeCode, xConsigneeName = b.ConsigneeName,  " & vbCrLf & _
                  " 	xConsigneeAddress = b.ConsigneeAddress, xBuyerCode = b.BuyerCode,  " & vbCrLf & _
                  " 	xBuyerName = b.BuyerName, xBuyerAddress = b.BuyerAddress,  " & vbCrLf & _
    ...
    Private Sub up_GridLoadWhenEventChange()
        ...
        Using sqlConn As New SqlConnection(clsGlobal.ConnectionString)
            ...
            ls_SQL = " select top 0 '' NoUrut, '' [AffiliateID],'' [ConsigneeCode],'' [BuyerCode],'' [AffiliateID], " & vbCrLf & _
                  " '' [AffiliateName],'' [Address],'' [BuyerAddress],'' [ConsigneeAddress],'' [DestinationPort], " & vbCrLf & _
                  " ''[OverseasCls],'' [City],'' [PostalCode],'' [Phone1],'' [Phone2],'' [Fax],'' [NPWP], " & vbCrLf & _
                  " '' [KantorPabean],'' [IzinTPB],'' [BCPerson],'' [PODeliveryBy],'' [FolderOES],'' [ErrorCls], " & vbCrLf & _
                  " '' xConsigneeCode, '' xConsigneeName, '' xConsigneeAddress, '' xBuyerCode, '' xBuyerName,  " & vbCrLf & _
                  " '' xBuyerAddress, '' xAffiliateName, '' xAddress, '' xCity, '' xPostalCode, '' xPhone1,  " & vbCrLf & _
                  " '' xPhone2, '' xFax, '' xNPWP, '' xKantorPabean, '' xIzinTPB, '' xBCPerson, '' xDestinationPort,  " & vbCrLf & _
                  " '' xFolderOES, '' xPODeliveryBy, '' xOverseasCls " & vbCrLf & _
                  "  " & vbCrLf & _
                  "  "
            ...
            If Uploader.HasFile Then
                ...
                Using sqlConn As New SqlConnection(clsGlobal.ConnectionString)
                    ...
                    Try
                        ...
                        MyCommand.CommandText = ("SELECT * FROM [" & pTableCode & "A3:V65536]")
                        ...
                        If dtDetail.Rows.Count > 0 Then
                            For i = 0 To dtDetail.Rows.Count - 1
                                If IsDBNull(dtDetail.Rows(i).Item(0)) = False Then
                                    ...
                                    dtUploadDetail.ConsigneeCode = IIf(IsDBNull(dtDetail.Rows(i).Item(1)), "", dtDetail.Rows(i).Item(1))
                                    dtUploadDetail.BuyerCode = IIf(IsDBNull(dtDetail.Rows(i).Item(2)), "", dtDetail.Rows(i).Item(2))
                                    dtUploadDetail.AffiliateName = IIf(IsDBNull(dtDetail.Rows(i).Item(3)), "", dtDetail.Rows(i).Item(3))
                                    dtUploadDetail.Address = IIf(IsDBNull(dtDetail.Rows(i).Item(4)), "", dtDetail.Rows(i).Item(4))
                                    dtUploadDetail.ConsigneeName = IIf(IsDBNull(dtDetail.Rows(i).Item(5)), "", dtDetail.Rows(i).Item(5))
                                    dtUploadDetail.ConsigneeAddress = IIf(IsDBNull(dtDetail.Rows(i).Item(6)), "", dtDetail.Rows(i).Item(6))
                                    dtUploadDetail.BuyerName = IIf(IsDBNull(dtDetail.Rows(i).Item(7)), "", dtDetail.Rows(i).Item(7))
                                    dtUploadDetail.BuyerAddress = IIf(IsDBNull(dtDetail.Rows(i).Item(8)), "", dtDetail.Rows(i).Item(8))
                                    dtUploadDetail.DestinationPort = IIf(IsDBNull(dtDetail.Rows(i).Item(9)), "", dtDetail.Rows(i).Item(9))

                                    dtUploadDetail.City = IIf(IsDBNull(dtDetail.Rows(i).Item(10)), "", dtDetail.Rows(i).Item(10))
                                    dtUploadDetail.PostalCode = IIf(IsDBNull(dtDetail.Rows(i).Item(11)), "", dtDetail.Rows(i).Item(11))
                                    dtUploadDetail.Phone1 = IIf(IsDBNull(dtDetail.Rows(i).Item(12)), "", dtDetail.Rows(i).Item(12))
                                    dtUploadDetail.Phone2 = IIf(IsDBNull(dtDetail.Rows(i).Item(13)), "", dtDetail.Rows(i).Item(13))
                                    dtUploadDetail.Fax = IIf(IsDBNull(dtDetail.Rows(i).Item(14)), "", dtDetail.Rows(i).Item(14))
                                    dtUploadDetail.NPWP = IIf(IsDBNull(dtDetail.Rows(i).Item(15)), "", dtDetail.Rows(i).Item(15))
                                    dtUploadDetail.KantorPabean = IIf(IsDBNull(dtDetail.Rows(i).Item(16)), "", dtDetail.Rows(i).Item(16))
                                    dtUploadDetail.IzinTPB = IIf(IsDBNull(dtDetail.Rows(i).Item(17)), "", dtDetail.Rows(i).Item(17))
                                    dtUploadDetail.BCPerson = IIf(IsDBNull(dtDetail.Rows(i).Item(18)), "", dtDetail.Rows(i).Item(18))
                                    dtUploadDetail.PODeliveryBy = IIf(IsDBNull(dtDetail.Rows(i).Item(19)), "0", dtDetail.Rows(i).Item(19))
                                    dtUploadDetail.OverseasCls = IIf(IsDBNull(dtDetail.Rows(i).Item(20)), "0", dtDetail.Rows(i).Item(20))
                                    dtUploadDetail.FolderOES = IIf(IsDBNull(dtDetail.Rows(i).Item(21)), "", dtDetail.Rows(i).Item(21))
                        ...
                        Using sqlTran As SqlTransaction = sqlConn.BeginTransaction("uploadPO")
                            ...
                            For i = 0 To dtUploadDetailList.Count - 1
                                ...
                                ls_sql = " INSERT INTO [dbo].[UploadAffiliate] " & vbCrLf & _
                                          "            ([AffiliateID], [ConsigneeCode], [BuyerCode], [AffiliateName], [PODeliveryBy], [FolderOES], [Address], [ConsigneeName], [ConsigneeAddress], [BuyerName], [BuyerAddress],[City], [PostalCode], " & vbCrLf & _
                                          "             [Phone1],[Phone2],[Fax],[NPWP],[KantorPabean],[IzinTPB],[BCPerson],[ErrorCls], [DestinationPort], [OverseasCls]) " & vbCrLf & _
                                          "      VALUES " & vbCrLf & _
                                          "            ('" & PO.AffiliateID & "'" & vbCrLf & _
                                          "            ,'" & PO.ConsigneeCode & "' " & vbCrLf & _
                                          "            ,'" & PO.BuyerCode & "' " & vbCrLf & _
                                          "            ,'" & PO.AffiliateName & "' " & vbCrLf & _
                                          "            ,'" & PO.PODeliveryBy & "' " & vbCrLf & _
                                          "            ,'" & PO.FolderOES & "' " & vbCrLf & _
                                          "            ,'" & PO.Address & "' " & vbCrLf & _
                                          "            ,'" & PO.ConsigneeName & "' " & vbCrLf & _
                                          "            ,'" & PO.ConsigneeAddress & "' " & vbCrLf & _
                                          "            ,'" & PO.BuyerName & "' " & vbCrLf & _
                                          "            ,'" & PO.BuyerAddress & "' " & vbCrLf & _
                                          "            ,'" & PO.City & "' " & vbCrLf & _
                                          ...
                                          "            ,'" & PO.Fax & "' " & vbCrLf & _
                                          "            ,'" & PO.NPWP & "' " & vbCrLf & _
                                          "            ,'" & PO.KantorPabean & "' " & vbCrLf & _
                                          "            ,'" & PO.IzinTPB & "' " & vbCrLf & _
                                          "            ,'" & PO.BCPerson & "' " & vbCrLf & _
                                          "            ,'" & ls_error & "' " & vbCrLf & _
                                          "            ,'" & PO.DestinationPort & "' " & vbCrLf & _
                                          "            ,'" & PO.OverseasCls & "') "
            ...
            Try
                ...
                For i = 0 To grid.VisibleRowCount - 1
                    If grid.GetRowValues(i, "AffiliateID") <> "" Then
                        ls_Sql = " IF NOT EXISTS (select * from MS_Affiliate where AffiliateID = '" & grid.GetRowValues(i, "AffiliateID") & "')" & vbCrLf & _
                                  " BEGIN" & vbCrLf & _
                                  " INSERT INTO [dbo].[MS_Affiliate] " & vbCrLf & _
                                  "            ([AffiliateID] " & vbCrLf & _
                                  "            ,[ConsigneeCode] " & vbCrLf & _
                                  "            ,[BuyerCode] " & vbCrLf & _
                                  ...
                                  "            ,[OverseasCls] " & vbCrLf & _
                                  "            ,[PODeliveryBy] "

                        ls_Sql = ls_Sql + "            ,[FolderOES] " & vbCrLf & _
                                          "            ,[EntryDate] " & vbCrLf & _
                                          "            ,[EntryUser] ) " & vbCrLf & _
                                          "      VALUES " & vbCrLf & _
                                          "            ('" & grid.GetRowValues(i, "AffiliateID") & "' " & vbCrLf & _
                                          "            ,'" & grid.GetRowValues(i, "ConsigneeCode") & "' " & vbCrLf & _
                                          "            ,'" & grid.GetRowValues(i, "BuyerCode") & "' " & vbCrLf & _
                                          "            ,'" & grid.GetRowValues(i, "AffiliateName") & "' " & vbCrLf & _
                                          "            ,'" & grid.GetRowValues(i, "Address") & "' " & vbCrLf & _
                                          "            ,'" & grid.GetRowValues(i, "ConsigneeName") & "' " & vbCrLf & _
                                          "            ,'" & grid.GetRowValues(i, "ConsigneeAddress") & "' " & vbCrLf & _
                                          "            ,'" & grid.GetRowValues(i, "BuyerName") & "' " & vbCrLf & _
                                          "            ,'" & grid.GetRowValues(i, "BuyerAddress") & "' " & vbCrLf & _
                        ...
                        ls_Sql = ls_Sql + "            ,'" & grid.GetRowValues(i, "Phone1") & "' " & vbCrLf & _
                                          ...
                                          "            ,'" & grid.GetRowValues(i, "KantorPabean") & "' " & vbCrLf & _
                                          "            ,'" & grid.GetRowValues(i, "IzinTPB") & "' " & vbCrLf & _
                                          "            ,'" & grid.GetRowValues(i, "BCPerson") & "' " & vbCrLf & _
                                          "            ,'" & grid.GetRowValues(i, "DestinationPort") & "' " & vbCrLf & _
                                          "            ,'" & IIf(grid.GetRowValues(i, "OverseasCls").ToString.ToUpper = "YES", 1, 0) & "' " & vbCrLf & _
                                          "            ,'" & grid.GetRowValues(i, "PODeliveryBy") & "' " & vbCrLf & _
                                          "            ,'" & grid.GetRowValues(i, "FolderOES") & "' " & vbCrLf & _
                                          "            ,getdate() " & vbCrLf & _
                                          "            ,'UPLOAD') " & vbCrLf & _
                                          " END " & vbCrLf & _
                                          " ELSE " & vbCrLf & _
                                          " BEGIN" & vbCrLf & _
                                          "      UPDATE [dbo].[MS_Affiliate] SET " & vbCrLf & _
                                          "       [AffiliateName] = '" & grid.GetRowValues(i, "AffiliateName") & "' " & vbCrLf & _
                                          "       ,[ConsigneeCode] = '" & grid.GetRowValues(i, "ConsigneeCode") & "' " & vbCrLf & _
                                          "       ,[BuyerCode] = '" & grid.GetRowValues(i, "BuyerCode") & "' " & vbCrLf & _
                                          "       ,[Address] = '" & grid.GetRowValues(i, "Address") & "' " & vbCrLf & _
                                          "       ,[ConsigneeName] = '" & grid.GetRowValues(i, "ConsigneeName") & "' " & vbCrLf & _
                                          "       ,[ConsigneeAddress] = '" & grid.GetRowValues(i, "ConsigneeAddress") & "' " & vbCrLf & _
                                          "       ,[BuyerName] = '" & grid.GetRowValues(i, "BuyerName") & "' " & vbCrLf & _
                                          "       ,[BuyerAddress] = '" & grid.GetRowValues(i, "BuyerAddress") & "' " & vbCrLf & _
                                          ...
                                          "       ,[KantorPabean] = '" & grid.GetRowValues(i, "KantorPabean") & "' " & vbCrLf & _
                                          "       ,[IzinTPB] = '" & grid.GetRowValues(i, "IzinTPB") & "' " & vbCrLf & _
                                          "       ,[BCPerson] = '" & grid.GetRowValues(i, "BCPerson") & "' " & vbCrLf & _
                                          "       ,[PODeliveryBy] = '" & grid.GetRowValues(i, "PODeliveryBy") & "' " & vbCrLf & _
                                          "       ,[FolderOES] = '" & grid.GetRowValues(i, "FolderOES") & "' " & vbCrLf & _
                                          "       ,[DestinationPort] = '" & grid.GetRowValues(i, "DestinationPort") & "' " & vbCrLf & _
                                          "       ,[OverseasCls] = '" & IIf(grid.GetRowValues(i, "OverseasCls").ToString.Trim.ToUpper = "YES", 1, 0) & "' " & vbCrLf & _
                                          "      WHERE [AffiliateID] = '" & grid.GetRowValues(i, "AffiliateID") & "' " & vbCrLf & _
                                          " END"
